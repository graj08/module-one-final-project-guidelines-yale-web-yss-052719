...
potatoes = Ingredient.create(name: "potatoes",price: 2.00,quantity_at_grocery: 1,measure: "lb")
curry = Ingredient.create(name: "curry",price: 1.50,quantity_at_grocery: 8,measure: "oz")
beef = Ingredient.create(name: "beef",price: 5.00,quantity_at_grocery: 1,measure: "lb")
